...
// Valores por defecto para nuestro carrusel de valores
const DEFAULT_ITEMS: CarouselItem[] = [
  ...
  {
    title: 'Innovación',
    description: 'Desarrollamos soluciones avanzadas que anticipan las necesidades del mercado.',
    id: 6,
          ...
          return (
            <motion.div
              ...
              className={`relative shrink-0 flex flex-col ${
                round
                  ? 'items-center justify-center text-center bg-primary-500 border-0'
                  : 'items-start justify-between bg-primary-500 border border-primary-600 rounded-[12px]'
              } overflow-hidden cursor-grab active:cursor-grabbing`}
              style={{
                width: itemWidth,
                height: round ? itemWidth : '180px',
                rotateY: rotateY,
            ...
            >
              <div className={`${round ? 'p-0 m-0' : 'mb-4 p-5'}`}>
                <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-primary-600">
                  {item.icon}
                </span>
              </div>
              <div className="p-5">
