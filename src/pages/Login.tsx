...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="dark:hidden absolute inset-0 z-0 pointer-events-none bg-gradient-to-br from-primary-50 via-white to-primary-100" />
            ...
            <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center relative bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/10">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  Continúa comprando los mejores productos que tenemos para ti
                </p>
